...
console.log('1.1 + 0.3');
console.log(1.1 + 0.3);
console.log('accurate', accurate.add(1.1, 0.3));
console.log('\r\n');
...
console.log('1.1 - 0.2');
console.log(1.1 - 0.2);
console.log('accurate', accurate.subtract(1.1, 0.2));
console.log('\r\n');
...
console.log('1.1 * 0.1');
console.log(1.1 * 0.1);
console.log('accurate', accurate.mul(1.1, 0.1));
console.log('\r\n');
...
console.log('1.1 % 1');
console.log(1.1 % 1);
console.log('accurate', accurate.modulo(1.1, 1));
console.log('\r\n');